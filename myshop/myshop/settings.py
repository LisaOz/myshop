...
SECRET_KEY = 'django-insecure-4h11$cs_v@coa7#m-1!*xclr=6l-5okv=nwlul%%u6%=%auk#v'
...
# These are test environment keys.
# The production environment keys will be available when Stripe account is validated
